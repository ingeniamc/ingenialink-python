...
class PDOServo(Servo):
    ...
    RPDO_MAP_REGISTER_SUB_IDX_0: ClassVar[list[str]] = ["RPDO_MAP_REGISTER_SUB_IDX_0"]
    RPDO_MAP_REGISTER_SUB_IDX_1: ClassVar[list[str]] = ["RPDO_MAP_REGISTER_SUB_IDX_1"]
    ...
    TPDO_MAP_REGISTER_SUB_IDX_0: ClassVar[list[str]] = ["TPDO_MAP_REGISTER_SUB_IDX_0"]
    TPDO_MAP_REGISTER_SUB_IDX_1: ClassVar[list[str]] = ["TPDO_MAP_REGISTER_SUB_IDX_1"]
