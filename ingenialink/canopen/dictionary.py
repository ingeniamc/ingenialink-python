...
class CanopenDictionaryV2(DictionaryV2):
    ...
    _MONITORING_DISTURBANCE_REGISTERS: list[CanopenRegister] = [  # noqa: RUF012
        CanopenRegister(
    ...
    def _read_xdf_register(self, register: Element) -> Optional[CanopenRegister]:
        ...
        try:
            ...
            logger.exception(
                f"Register with ID {current_read_register.identifier} has not attribute.",
            )
            return None
