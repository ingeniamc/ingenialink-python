...
class CanEthRegister(Register):
    """CANopen and Ethernet Register Base class.
    ...
    def __init__(self, idx, dtype, access, identifier=None, units=None, cyclic="CONFIG",
        ...
        super().__init__(identifier, units, cyclic, dtype, access,
                         phy, subnode, storage, reg_range, labels,
                         enums, enums_count, cat_id, scat_id, internal_use)
