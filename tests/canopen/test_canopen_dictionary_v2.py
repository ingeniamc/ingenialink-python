...
def test_read_dictionary():
    dictionary_path = resources.canopen.TEST_DICT_CAN
...
def test_read_dictionary_registers_multiaxis():
    ...
    dictionary_path = resources.canopen.TEST_DICT_CAN_AXIS
...
def test_read_dictionary_registers_attr_errors():
    dictionary_path = resources.canopen.TEST_DICT_CAN_NO_ATTR_REG
